...
<ul>
	...
	<li>
		REST client: <b>Insomnia Core</b>
		<table>
			<tr>
				<td>post</td>
				<td><i>/user</i></td>
				<td></td>
				<td><b>createUser</b></td>
			</tr>
			<tr>
				<td>get</td>
				<td><i>/user</i></td>
				<td><a href='/user'>/user</a></td>
				<td><b>getAllUsers</b></td>
			</tr>
			<tr>
				<td>delete</td>
				<td><i>/user/:userId</i></td>
				<td></td>
				<td><b>deleteUser</b></td>
			</tr>
			<tr>
				<td>put</td>
				<td><i>/user/:userId</i></td>
				<td></td>
				<td><b>updateUser</b></td>
			</tr>
			<tr>
				<td>get</td>
				<td><i>/seasrch</i></td>
				<td><a href='/search?username=Linus'>/search?username=Linus</a></td>
				<td><b>queryUsername</b></td>
			</tr>
			<tr>
				<td>get</td>
				<td><i>/getuser/:userId</i></td>
				<td><a href='/getuser/603d0a7ca2346a450ff4a0a8'>/getuser/603d0a7ca2346a450ff4a0a8</a></td>
				<td><b>getUserById</b></td>
			</tr>
		</table>
	</li>
	<li>
...
<ul>
	<li>Create (POST) - Make something (application.post)</li>
	<li>Read (GET) - Get something (application.get)</li>
	<li>Update (PUT) - Change something (application.put)</li>
	<li>Delete (DELETE) - Remove something (application.delete)</li>
</ul>
<ul>
	<li><a href='http://expressjs.com/en/api.html#app.use'>application.use</a></li>
	<li><a href='http://expressjs.com/en/api.html#app.get.method'>application.get</a></li>
	<li><a href='https://expressjs.com/en/guide/writing-middleware.html'>Middleware functions</a></li>
</ul>
<p><b>MVC (Model View Controller)</b> - Design Pattern for fullstack API<br>VIEW <-> CONTROLLER <-> MODEL <-> <i><a href='https://medium.com/spidernitt/orm-and-odm-a-brief-introduction-369046ec57eb' title='e.g mongoose - ODM (Object Document Mapping) used for noSQL'>ODM</a></i> <-> <i>DATABASE</i></p>
	`);
});
